...
//         var o = new g.Api(a), s = a.oClasses, k = a.oLanguage.oPaginate, t = a.oLanguage.oAria.paginate || {}, f, d,
//             p = 0, q = function (c, g) {
...
//                 };
//                 l = 0;
//                 for (h = g.length; l < h; l++) if (e = g[l], b.isArray(e)) q(c, e); else {
//                     d = f = "";
//                     switch (e) {
//                         case "ellipsis":
...
//                     }).html(f)).appendTo(c), a.oApi._fnBindAction(i, {action: e}, m), p++)
//                 }
//             }, i;
//         try {
...
//         } catch (u) {
//         }
//         q(b(h).empty().html('<ul class="uk-pagination uk-pagination-right"/>').children("ul"),
//             m);
